...
<head>
  ...
  <title>NMS PUSTEKSAT-Details Divece</title>
      ...
      <div id="content">
        ...
        <div id="print-area-1" class="print-area">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Details PC</h1>
          </div>
        ...
        <br>
                ...
                $intname[]=$row['intname'];
                  ...
                  $a=$a+1;
                    ...
                    break;
                      ...
                      require_once("koneksi/koneksi.php");
                      $ambil_kondisi="SELECT times,dates,intstatus,intspeed FROM interfaces WHERE id_connection='$id_connection' AND intname='$intname' ORDER BY dates DESC,times DESC LIMIT 1";
                      ...
                      //ambil Availability selama 1 jam=60 request polling
                      $id_connection=$_GET['id_connection'];
                      $uptime=array();
                      $time=array();
                      $intstatus=array();
                      $ambil_connect="SELECT * FROM interfaces WHERE id_connection='$id_connection' ORDER BY dates DESC, times DESC LIMIT 120";
                      ...
                      //cek udah 1 jam blm
                      require_once("koneksi/koneksi.php");
                      $ambil_connect1="SELECT * FROM interfaces WHERE id_connection='$id_connection' ORDER BY dates DESC, times DESC LIMIT 60";
                      $j=array();
          ...
          <div class=\"text-left font-italic\">* Availability for the latest 1 hour </div><br>
          ";
  echo "<b>Interface Logs</b><br>
        <div class=\"table-responsive\">
