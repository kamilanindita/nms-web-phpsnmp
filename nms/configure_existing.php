...
<head>
  ...
  <title>NMS PUSTEKSAT-Configure Existing</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Configure Existing</h1>
                  ...
                  <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    <thead>
                      <tr>
                        ...
                        <th class="text-center">Type Device</th>
                        <th class="text-center">Description</th>
                        <th class="text-center">Location</th>
                        <th class="text-center">Details | Reconfigure</th>
                      </tr>
                    </thead>
                    <tfoot>
                      <tr>
                    ...
                    <tbody>
                      ...
                      require_once("koneksi/koneksi.php");
                        ...
                        <tr>
                          <td>".$row['grup']."</td>
                          <td>".$row['name']."</td>
                          <td>".$row['type_device']."</td>
                          <td>".$row['description']."</td>
                          <td>".$row['location']."</td>
                          <td><div class=\"text-center\"><a href=\"details_device.php?id=$id\" class=\"btn btn-info\">Details</a> <a href=\"reconfigure_device.php?id=$id\" class=\"btn btn-warning\" >Reconfig</a></div></td>
                        </tr>
                        ";
                      }
                      ?>
