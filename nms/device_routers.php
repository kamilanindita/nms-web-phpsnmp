...
<head>
  ...
  <title>NMS PUSTEKSAT-Device Routers</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <!-- Page Heading -->
            <h1 class="h3 mb-2 text-gray-800">Router</h1>
          <!--  <p class="mb-4">DataTables is a third party plugin that is used to generate the demo table below. For more information about DataTables, please visit the <a target="_blank" href="https://datatables.net">official DataTables documentation</a>.</p>-->
			...
			$ambil="SELECT * FROM devices WHERE type_device='Router'";
			...
			while($row=mysqli_fetch_array($hasilambil,MYSQLI_ASSOC)){
                        ...
                        <tr>
                          ...
                          <td>".$row['location']."</td>
                          <td><div class=\"text-center\"><a href=\"details_router.php?id=$id&id_connection=$id_connection\" class=\"btn btn-info\">Details</a> <a href=\"charts_router.php?id_connection=$id_connection\" class=\"btn btn-success\">Charts</a></div></td>
                        </tr>
                        ";
                      }
                      ?>
