...
<head>
  ...
  <title>NMS PUSTEKSAT-Device PC</title>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="device_pc.php">PC</a>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">PC</h1>
              ...
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    $ambil="SELECT * FROM devices WHERE type_device='PC'";
                    ...
                    while($row=mysqli_fetch_array($hasilambil,MYSQLI_ASSOC)){
                      ...
                      <tr>
                        ...
                        <td>".$row['location']."</td>
                        <td><div class=\"text-center\"><a href=\"details_pc.php?id=$id&id_connection=$id_connection\" class=\"btn btn-info\">Details</a> <a href=\"#\" class=\"btn btn-success\">Charts</a></div></td>
                      </tr>
                      ";
			//charts_router.php?id_connection=$id_connection
                    }
                    ?>
