...
<head>
  ...
  <title>NMS PUSTEKSAT-Configure New Divece</title>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="configure_new_device.php">Add New Device</a>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Configure New Divece</h1>
          ...
          <div class="row">
            ...
            <form  class="user" action="proses_add_new_device.php" method="POST">
            <div class="row">
              <div class="col-lg-6">
                <div class="p-5">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="Group" name="grup" id="group" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <textarea class ="form-control" rows="3" name="location" placeholder="Location" id="location"></textarea>
                    </div>

                </div>
		<br><br><br>
 		<p style="color:red;">*only available for mikrotik dan windows</p>
              </div>		    
              ...
              <div class="col-lg-6">
                <div class="p-5">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="IP Address Device" name="ip_device" id="ipaddress" required>
                    </div>
                    <div class="form-group">
                      <label for="snmpversion">SNMP Version</label>
                      <select class="form-control" name="snmp_version" id="snmpversion">
                        <option>---<option>
                        <option>1</option>
                        <option>2</option>
                        <option>3</option>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class=" form-control" placeholder="User Community" name="user_community" id="usercommunity">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="Authentication Password" name="auth_password" id="authpassword">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="Encryption Password" name="encrypt_password" id="encryptpassword">
                    </div>
