      ...
      <div id="content">
        ...
        <div id="print-area-1" class="print-area">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Fault</h1>
          </div>
        ...
        <br>
                ...
                $intname[]=$row['intname'];
                  ...
                  $a=$a+1;
                    ...
                    break;
                      ...
                      //ambil Availability total uptime
                      $id_connection=$_GET['id_connection'];
                      $uptime=array();
                      $time=array();
                      $intstatus=array();
                      $ambil_connect="SELECT * FROM interfaces WHERE id_connection='$id_connection'";
                      ...
                      //ambil Availability total uptime
                      require_once("koneksi/koneksi.php");
                      $ambil_connect1="SELECT * FROM interfaces WHERE id_connection='$id_connection'";
                      $j=array();
          ...
          <div class=\"text-left font-italic\">*Availability for the latest $jj minutes</div><br>
          ";
