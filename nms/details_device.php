...
<head>
  ...
  <title>NMS PUSTEKSAT-Details Configure Divece</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Details Configure Divece</h1>
          ...
          <div class="row">
              ...
              ";
                ...
                <div class=\"p-5\">
                    ...
                    <div class=\"form-group\">
                      ...
                      <input type=\"text\" class=\"form-control\" value=\"$grup\" name=\"grup\" id=\"group\" disabled>
                    </div>
                    <div class=\"form-group\">
                      <label for=\"name\">Name</label>
                      <input type=\"text\" class=\"form-control\" value=\"$name\" name=\"name\" id=\"name\" disabled>
                    </div>
                    <div class=\"form-group\">
                      <label for=\"type_device\">Select Type Device:</label>
                      <input type=\"text\" class=\"form-control\" value=\"$type_device\" name=\"type_device\" id=\"type_device\" disabled>
                    </div>
                    <div class=\"form-group\">
                      <label for=\"description\">Description</label>
                      <textarea class =\"form-control\" rows=\"3\" name=\"description\"  id=\"description\" disabled>$description</textarea>
                    </div>
                    <div class=\"form-group\">
                      <label for=\"location\">Location</label>
                      <textarea class =\"form-control\" rows=\"3\" name=\"location\"  id=\"location\" disabled>$location</textarea>
                    </div>
              ...
              echo"
                <div class=\"p-5\">
                    ...
                    <div class=\"form-group\">
                      ...
                      <input type=\"text\" class=\"form-control\" value=\"$ip_device\" name=\"ip_device\" id=\"ipaddress\" disabled>
                    </div>
                    <div class=\"form-group\">
                      <label for=\"snmpversion\">SNMP Version</label>
                      <input type=\"text\" class=\" form-control\" value=\"$snmp_version\" name=\"snmp_version\" id=\"snmpversion\" disabled>
                    </div>
                    <div class=\"form-group\">
                      <label for=\"usercommunity\">User Comunity</label>
                      <input type=\"text\" class=\" form-control\" value=\"$user_community\" name=\"user_community\" id=\"usercommunity\" disabled>
                    </div>
                    <div class=\"form-group\">
                      <label for=\"mechanism\">Mechanism</label>
                      <input type=\"text\" class=\" form-control\" value=\"$mechanism\" name=\"mechanism\" id=\"mechanism\" disabled>
                    </div>
                    <div class=\"form-group\">
                      <label for=\"authprotocol\">Authentication Protocol</label>
                      <input type=\"text\" class=\" form-control\" value=\"$auth_protocol\" name=\"auth_protocol\" id=\"authprotocol\" disabled>
                    </div>
                    <div class=\"form-group\">
                      <label for=\"authpassword\">Authentication Password</label>
                      <input type=\"text\" class=\"form-control\" value=\"$auth_password\" name=\"auth_password\" id=\"authpassword\" disabled>
                    </div>
                    <div class=\"form-group\">
                      <label for=\"authprotocol\">Encryption Protocol</label>
                      <input type=\"text\" class=\" form-control\" value=\"$encrypt_protocol\" name=\"encrypt_protocol\" id=\"encryptprotocol\" disabled>
                    </div>
                    <div class=\"form-group\">
                      <label for=\"encryptpassword\">Encryption Password</label>
                      <input type=\"text\" class=\"form-control\" value=\"$encrypt_password\" name=\"encrypt_password\" id=\"encryptpassword\" disabled>
                    </div>
            ...
            <br>
            <div class=\"text-left\">
            <a href=\"reconfigure_device.php?id=$id\" class=\"btn btn-info\">Reconfigure</a>
