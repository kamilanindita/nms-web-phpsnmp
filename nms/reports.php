...
<head>
  ...
  <title>NMS PUSTEKSAT-Reports</title>
	  ...
	  <div class="card shadow mb-4">
			...
			$link="#";
                      ...
                      <tr>
                        ...
                        <td>".$row['location']."</td>
                        <td><div class=\"text-center\"><a href=\"$link?id=$id&id_connection=$id_connection\" class=\"btn btn-info\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Fault&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a> <a href=\"report_accounting.php?id=$id&id_connection=$id_connection\" class=\"btn btn-danger\">Accounting</a></div></td>
                      </tr>
                      ";
                    }
                    ?>
