...
<head>
  ...
  <title>NMS PUSTEKSAT-Edit User Profile</title>
                  ...
                  <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                      <!-- Nested Row within Card Body -->
                        ...
                        $username = $_SESSION['username'];
                        $ambil_iduser="SELECT * FROM users WHERE username='$username'";
                        $hasil_ambil_user=$db->query($ambil_iduser);
                        while($row3=mysqli_fetch_array($hasil_ambil_user,MYSQLI_ASSOC)){
                        ...
                        <div class=\"col-lg-6\">
                            <div class=\"p-5\">
                              <form class=\"user\" action=\"proses_update_user.php\" method=\"POST\">
                                <input type=\"text\" name=\"id_user\" value=\"$id_user\" hidden>
                                <div class=\"form-group\">
                                  <label for=\"username\">Username:</label>
                                  <input type=\"text\" class=\"form-control\" value=\"$username\" name=\"username\" id=\"username\" required>
                                </div>
                                <div class=\"form-group\">
                                ...
                                <div class=\"text-left\">
                                <button class=\"btn btn-primary btn-block col-lg-4\">
                                  Save
                                </button>
                                </div>
                              </form>
